...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  "TCPReceive",                        /* fcnName */
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2024b\\toolbox\\target\\supportpackages\\parrot\\+parrot\\TCPReceive.p"/* pathName */
};

static emlrtRSInfo b_emlrtRSI = { 1,   /* lineNo */
  "TCPReceive",                        /* fcnName */
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2024b\\toolbox\\target\\supportpackages\\shared_linuxservices\\+sharedlinux\\TCPRecei"
  "ve.p"                               /* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
...
static void mw__internal__call__reset(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance, const emlrtStack *sp, uint8_T *c_y0, int8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_q3FDYV1QLddbwlDvlWgrzC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S, int_T tid)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S, int_T tid)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
  InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *moduleInstance =
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC *)calloc(1, sizeof
    (InstanceStruct_q3FDYV1QLddbwlDvlWgrzC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_q3FDYV1QLddbwlDvlWgrzC);
  ssSetmdlInitializeConditions(S, mdlInitialize_q3FDYV1QLddbwlDvlWgrzC);
  ssSetmdlUpdate(S, mdlUpdate_q3FDYV1QLddbwlDvlWgrzC);
  ssSetmdlDerivatives(S, mdlDerivatives_q3FDYV1QLddbwlDvlWgrzC);
  ssSetmdlTerminate(S, mdlTerminate_q3FDYV1QLddbwlDvlWgrzC);
  ssSetmdlEnable(S, mdlEnable_q3FDYV1QLddbwlDvlWgrzC);
  ssSetmdlDisable(S, mdlDisable_q3FDYV1QLddbwlDvlWgrzC);
...
static void mdlProcessParameters_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S)
{
}

void method_dispatcher_q3FDYV1QLddbwlDvlWgrzC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_q3FDYV1QLddbwlDvlWgrzC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_q3FDYV1QLddbwlDvlWgrzC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_q3FDYV1QLddbwlDvlWgrzC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_q3FDYV1QLddbwlDvlWgrzC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: q3FDYV1QLddbwlDvlWgrzC.\n"
...
mxArray *cgxe_q3FDYV1QLddbwlDvlWgrzC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_q3FDYV1QLddbwlDvlWgrzC_fallback_info(void)
{
